...
class TestLanguagesRankingExtractor(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.expected_output_columns_after_merge = ['Proficient in Java', 'Proficient in C++',
                                                    'Proficient in C#', 'Proficient in Python',
                                                    'Proficient in Ruby', 'Proficient in C', 'Proficient in JavaScript',
                                                    'Proficient in Objective-C', 'Proficient in Visual Basic',
                                                    'Proficient in PHP']
        ...
        self.lre = LanguagesRankingExtractor(source_data=self.df_input, prefix_to_remove='Proficient in ',
                                             entries_merge_list=self.entries_merge_list)
